...
//             script = "weaken.js"
//             // get available threads from util.js - limit thread usage depending on server need
//             const securityToReduce = currentSec - securityThresh;
//             const maxWeakenThreads = Math.ceil(securityToReduce / ns.weakenAnalyze(1));
...
//             const targetMoney = ns.getServerMaxMoney(target) * cfg.moneyThresh;


//             const growMultiplier = targetMoney / safeMoney
//             const maxGrowThreads = Math.ceil(ns.growthAnalyze(target, growMultiplier));
//             const threads = Math.min(getAvailableThreads(ns, scriptHost, script), maxGrowThreads);

//             script = "grow.js"
//             const availableThreads = getAvailableThreads(ns, scriptHost, script);
//             threads = Math.min(availableThreads, maxGrowThreads);
